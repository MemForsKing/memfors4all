...
class Handlesf(taskmods.DllList):
    ...
    def render_text(self, outfd, data):
        ...
        for pid, handle, object_type, name in data:
            ...
            outfd.write("{0:#x}||{1}||{2:#x}||{3:#x}||{4}||{5}\n".format(offset, pid, handle.HandleValue, handle.GrantedAccess, object_type, name))
